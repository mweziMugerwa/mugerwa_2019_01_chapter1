...
```{r processed rasters}
# access
access <- raster(paste0(dir,"/output/geo-proc/rasters/global_accessibility.tif"))

# biomes
biomes <- raster(paste0(dir,"/output/geo-proc/rasters/global_biomes.tif"))

# income
income <- raster(paste0(dir,"/output/geo-proc/rasters/global_country_income_group.tif"))

# elevation
elevation <- raster(paste0(dir,"/output/geo-proc/rasters/global_elevation.tif"))

# forloss
for_loss <- raster(paste0(dir,"/output/geo-proc/rasters/global_forest_loss.tif"))

# cum_hum_impact
cum_hum_impact <- raster(paste0(dir,"/output/geo-proc/rasters/global_hum_impact_spp.tif"))

# humfoot_print
humfoot_print <- raster(paste0(dir,"/output/geo-proc/rasters/global_humfoot.tif"))

# hum_mod
hum_mod <- raster(paste0(dir,"/output/geo-proc/rasters/global_hummod.tif"))

# ifl
ifl <- raster(paste0(dir,"/output/geo-proc/rasters/global_ifl.tif"))

# threat_species
threat_species <- raster(paste0(dir,"/output/geo-proc/rasters/global_iucn_no_threat_species.tif"))

# sp_datadef
sp_datadef <- raster(paste0(dir,"/output/geo-proc/rasters/global_iucn_datadef_species.tif"))

# sp_rich
sp_rich <- raster(paste0(dir,"/output/geo-proc/rasters/global_iucn_species_rich.tif"))

# wdpa
wdpa <- raster(paste0(dir,"/output/geo-proc/rasters/global_iucn_wdpa.tif"))

# tri
tri <- raster(paste0(dir,"/output/geo-proc/rasters/global_tri.tif"))
```
