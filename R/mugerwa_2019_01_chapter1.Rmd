...
science_theme = theme(panel.grid.major = element_line(size = 0.5, color = "grey"),
                      axis.line = element_line(size = 0.7, color = "black"), legend.position = c(0.85,0.7),
                      text = element_text(size = 14))

science_theme_facets = theme(panel.grid.major = element_line(size = 0.5, color = "grey"),
                             axis.line = element_line(size = 0.7, color = "black"), legend.position =
                               c(0.80,0.40), text = element_text(size = 24))

science_theme_distribution = theme(panel.grid.major = element_line(size = 0.5, color = "grey"),axis.line =
                                     element_line(size = 0.7, color = "black"), text = element_text(size =22))

science_theme_distribution_diparity = theme(panel.grid.major = element_line(size = 0.5, color ="grey"),
                                            axis.line = element_line(size = 0.7, color = "black"),
                                            legend.position="top",text = element_text(size = 22))
...
science_theme_distribution = theme(panel.grid.major = element_line(size = 0.5, color = "grey"),
                                   axis.line = element_line(size = 0.7, color = "black"), text =
...
# Bivariate maps
# source: https://gist.github.com/scbrown86/2779137a9378df7b60afd23e0c45c188
...
# write raster
# writeRaster(biome1.r, paste0(dir, "/data-raw/geo-raw/raster/biome1.tif"))
 
# read in raster
# biome1 <- raster(paste0(dir, "/data-raw/geo-raw/raster/biome1.tif"));plot(biome1)

# load biome shapefile 1 created from the raster. This is done in qgis
biome1.shp <- st_read(paste0(dir,"/data-raw/geo-raw/shp/biome1.shp"));names(biome1.shp);head(biome1.shp)
...
predictorsBiome1 <- raster::stack(access,income,elevation,for_loss,cum_hum_impact,ifl,sp_rich,wdpa,tri)
...
# Data
```{r processed rasters for biome 1: tropical moist forests}
# access
...
# write raster
# writeRaster(biome7.r, paste0(dir, "/data-raw/geo-raw/raster/biome7.tif"))
 
# read in raster
# biome7 <- raster(paste0(dir, "/data-raw/geo-raw/raster/biome7.tif"));plot(biome7)

# load biome shapefile 1 created from the raster. This is done in qgis
biome7.shp <- st_read(paste0(dir,"/data-raw/geo-raw/shp/biome7.shp"));names(biome7.shp);head(biome7.shp)
...
# predictorsBiome7 <- raster::stack(access,income,elevation,for_loss,cum_hum_impact,ifl,sp_rich,wdpa,tri)
...
# Data
```{r processed rasters for biome7: tropical grasslands}
# access
...
# write raster
# writeRaster(biome12.r, paste0(dir, "/data-raw/geo-raw/raster/biome12.tif"))
 
# read in raster
# biome12 <- raster(paste0(dir, "/data-raw/geo-raw/raster/biome12.tif"));plot(biome12)

# load biome shapefile 1 created from the raster. This is done in qgis
biome12.shp <- st_read(paste0(dir,"/data-raw/geo-raw/shp/biome12.shp"));names(biome12.shp);head(biome12.shp)
# make occurrence data spatial, assign coordinate reference system to spatial points
...
# create a raster stack to be masked with biome4
# predictorsBiome12 <- raster::stack(access,income,elevation,for_loss,cum_hum_impact,ifl,sp_rich,wdpa,tri)
...
# Data
```{r processed rasters for biome12: Mediterranean forests}
# access
...
# # write raster
# writeRaster(biome4.r, paste0(dir, "/data-raw/geo-raw/raster/biome4.tif"))
 
# read in raster
# biome4 <- raster(paste0(dir, "/data-raw/geo-raw/raster/biome4.tif"));plot(biome4)

# load biome shapefile 1 created from the raster. This is done in qgis
biome4.shp <- st_read(paste0(dir,"/data-raw/geo-raw/shp/biome4.shp"));names(biome4.shp);head(biome4.shp)
...
# create a raster stack to be masked with biome4
# predictorsBiome4 <- raster::stack(access,income,elevation,for_loss,cum_hum_impact,ifl,sp_rich,wdpa,tri)
...
# save the new covariate rasters (masked to biome) as .tif
# writeRaster(biome4_studyArea_Mask,filename=paste0(dir,"/output/geo-proc/rasters/biomes/biome4/",names(biome4_studyArea_Mask),".tif"),bylayer=TRUE)
```

# Data
```{r processed rasters for biome4: Temperate forests}
# access
...
# Collinearity test among predictors
```{r collinearity test among predictors}
...
# Visualising distribution of avialable vs. locations
...
# Country income group
income_tbl <- avail_locs %>% group_by(income) %>% tally()
income <- table(income=avail_locs$income, data=avail_locs$data)
...
# IFL
ifl_tbl <- avail_locs %>% group_by(IFL) %>% tally()
ifl <- table(ifl=avail_locs $IFL, data=avail_locs$data)
...
# WDPA
wdpa_tbl <- avail_locs %>% group_by(protected) %>% tally()
wdpa <- table(wdpa = avail_locs$protected, data=avail_locs$data)
...
# Biomes
biomes_tbl <- avail_locs %>% group_by(biomes) %>% tally()%>% arrange(desc(biomes))
...
# Generate background points for use in the maxent model
...
# subset data for only occurrence data
occ_data <- subset(corr_matrix,data=="Occurrence")
...
# Figure
```{r extended data figure 2: random and available data distribution}
# For continuous predictors
# number of impacted species (cumulative human impact)
num_sp_impacted <- ggplot(data_distribution ,aes(x=data,y= num_sp_imp, fill = data, colour = data))+
theme_update(text = element_text(size=12))+
geom_flat_violin(position = position_nudge(x = .25, y = 0),adjust =2, trim = TRUE, alpha=0.7,color="white")+
geom_point(position = position_jitter(width = .23), size = .25,alpha=0.1, colour="grey")+
geom_boxplot(aes(x = data, y = num_sp_imp),outlier.shape = NA, alpha = 0.3, width = .1, colour = "BLACK")+
...
# access
data_distribution$access_hrs <- 1/60*(data_distribution$access)
access <- ggplot(data_distribution,aes(x=data,y= access_hrs, fill = data, colour = data))+
theme_update(text = element_text(size=20))+
geom_flat_violin(position = position_nudge(x = .25, y = 0),adjust =2, trim = TRUE, alpha=0.7,color="white")+
geom_point(position = position_jitter(width = .23), size = .25,alpha=0.1, colour="grey")+
geom_boxplot(aes(x = data, y = access_hrs),outlier.shape = NA, alpha = 0.3, width = .1, colour = "BLACK")+
...
# forest loss
data_distribution$forlossSQ<- sqrt(data_distribution$forloss  )
forloss <- ggplot(data_distribution,aes(x=data,y= forlossSQ, fill = data, colour = data))+
theme_update(text = element_text(size=12))+
geom_flat_violin(position = position_nudge(x = .25, y = 0),adjust =2, trim = TRUE, alpha=0.7,color="white")+
geom_point(position = position_jitter(width = .23), size = .25,alpha=0.1, colour="grey")+
geom_boxplot(aes(x = data, y = forlossSQ),outlier.shape = NA, alpha = 0.3, width = .1, colour = "BLACK")+
...
# TRI
tri <- ggplot(data_distribution,aes(x=data,y= TRI, fill = data, colour = data))+
theme_update(text = element_text(size=12))+
geom_flat_violin(position = position_nudge(x = .25, y = 0),adjust =2, trim = TRUE, alpha=0.7,color="white")+
geom_point(position = position_jitter(width = .23), size = .25,alpha=0.1, colour="grey")+
geom_boxplot(aes(x = data, y = TRI),outlier.shape = NA, alpha = 0.3, width = .1, colour = "BLACK")+
...
scale_fill_manual(values = c("grey75","grey25"))+
theme_bw()+
science_theme_distribution;access
tri

# Elevation
elevation <- ggplot(data_distribution,aes(x=data,y= elevation, fill = data, colour = data))+
theme_update(text = element_text(size=12))+
geom_flat_violin(position = position_nudge(x = .25, y = 0),adjust =2, trim = TRUE, alpha=0.7,color="white")+
geom_point(position = position_jitter(width = .23), size = .25,alpha=0.1, colour="grey")+
geom_boxplot(aes(x = data, y = elevation),outlier.shape = NA, alpha = 0.3, width = .1, colour = "BLACK")+
...
#species richness
sp_rich <- ggplot(data_distribution,aes(x=data,y= sp_rich, fill = data, colour = data))+
theme_update(text = element_text(size=12))+
geom_flat_violin(position = position_nudge(x = .25, y = 0),adjust =2, trim = TRUE, alpha=0.7,color="white")+
geom_point(position = position_jitter(width = .23), size = .25,alpha=0.1, colour="grey")+
geom_boxplot(aes(x = data, y = sp_rich),outlier.shape = NA, alpha = 0.3, width = .1, colour = "BLACK")+
...
# categorical predictors
# Country income group
income_tbl <- data_distribution %>% group_by(income) %>% tally(); income_tbl
income <- table(income=data_distribution$income, data=data_distribution$data);income
...
# IFL
ifl_tbl <- data_distribution %>% group_by(IFL) %>% tally(); ifl_tbl
ifl <- table(ifl=data_distribution $IFL, data=data_distribution$data);ifl
...
# WDPA
wdpa_tbl <- data_distribution %>% group_by(protected) %>% tally(); wdpa_tbl
wdpa <- table(wdpa = data_distribution$protected, data=data_distribution$data);wdpa
...
# Biomes
biomes_tbl <- data_distribution %>% group_by(biomes) %>% tally()%>% arrange(desc(biomes)); biomes_tbl
biomes <- table(biomes=data_distribution$biomes, data=data_distribution$data);biomes
...
# save
categorical2 <- biomes + wdpa + income + ifl
