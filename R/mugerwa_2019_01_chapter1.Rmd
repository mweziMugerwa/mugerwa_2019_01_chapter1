...
# Data: shapefiles,.csv tables, and rasters (checked)
```{r}
# shape files
...
# Generate background points for use in the maxent models (checked)
...
# Dividing occurrence data into training and testing sets for MaxEnt modelling (Checked)
...
# Biome1 (Tropical & Subtropical Moist Broadleaf Forests) MaxEnt (checked)
```{r biome 1 maxent}
# fit model
...
# Biome7 (Tropical & Subtropical Grasslands, Savannah and Shrubs) MaxEnt (checked)
```{r biome 7 maxent}
# fit model
...
# Biomes12 (Mediterranean Forests, Woodlands & Scrub) MaxEnt (checked)
```{r biome 12 maxent}
# fit model:
...
# Biome4 (Temperate Broadleaf & Mixed Forests) MaxEnt (checked)
```{r biome 4 maxent}
...
# Creating a Defaunation risk map: Biome 1 (Tropical & Subtropical Moist Broadleaf Forests) MaxEnt (checked)
```{r biome 1 Defaunation risk map' map}
...
# Creating a Defaunation risk map: Biome 7 (Tropical & Subtropical Grasslands, Savannah and Shrubs) MaxEnt (checked)
```{r biome 7 Defaunation risk map' map}
# normalize covariates
...
# Creating a Defaunation risk map: Biome 12 (Mediterranean Forests, Woodlands & Scrub) MaxEnt (checked)
```{r biome 12 Defaunation risk map' map}
# normalize covariates
...
# Creating a Defaunation risk map: Biome 4 (Temperate Broadleaf & Mixed Forests) MaxEnt (checked)
```{r biome 4 Defaunation risk map' map}
# normalize covariates
...
# Creating a bivariate map: Biome 1 (Tropical & Subtropical Moist Broadleaf Forests) MaxEnt (checked)
...
# Creating a bivariate map: Biome 7 (Tropical & Subtropical Grasslands, Savannah and Shrubs) MaxEnt (checked)
...
# Creating a bivariate map: Biome 12 (Mediterranean Forests, Woodlands & Scrub) MaxEnt (checked)
...
# Creating a bivariate map: Biome 4 (Temperate Broadleaf & Mixed Forests) MaxEnt (checked)
...
# Percent of locations in the different Defaunation risk map quintiles for all biomes (checked)
```{r percent of locs and Defaunation risk map)}
# as a matrix
