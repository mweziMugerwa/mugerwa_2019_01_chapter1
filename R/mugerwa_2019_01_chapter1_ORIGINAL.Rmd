...
# the plot
income_graph <- ggplot(data=dataframe, aes(x=Data, y=percent, fill= Income)) +
...
# the plot
ifl_graph <- ggplot(data=dataframe, aes(x=Data, y=percent, fill= IFL)) +
geom_bar(stat="identity",color="Black",alpha=0.5)+
#geom_text(aes(y=percent, label=percent), vjust=-0.25, color="black", size=5,position = position_dodge(0.5))+
...
# the plot
wdpa_graph <- ggplot(data=dataframe, aes(x=Data, y=percent, fill= Protected)) +
geom_bar(stat="identity",color="Black",alpha=0.5)+
...
biomes_graph <- ggplot(data=dataframe, aes(x=Data, y=percent, fill= Biomes)) +
